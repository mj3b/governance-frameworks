...
## CDCF Gate 1 Incubation Evaluation and Assurance Review — Version 1.4
...
| **Evaluating TAC member** | Mark Julius Banasihan, AI Governance and AI Safety Specialist |
| **AI assistance** | ChatGPT (OpenAI) and repository-development materials reflecting Claude / Claude Code (Anthropic) assisted with repository navigation, code-location discovery, source comparison, adversarial questioning, structural analysis, and drafting. AI output is treated as research assistance, not evidence, validation, legal advice, security attestation, canonical judgment, or CDCF authority. The evaluating member remains responsible for every retained claim, inference, risk classification, and recommendation. |
...
## Evaluating Member and Scope of Review

| Field | Detail |
|---|---|
| **Evaluating member** | Mark Julius Banasihan |
| **CDCF role** | Technical Advisory Council — AI Governance and AI Safety Specialist |
| **Primary review scope** | AI governance, AI safety, human accountability, human influence telemetry, algorithmic decision support, pseudonymization and external-AI workflow risk, evidence thresholds, deployment gates, appeal, remediation, institutional learning, and post-harm reform |
| **Research posture** | Research-intensive review grounded in AI safety, rationality, human oversight, corrigibility, interpretability, automation bias, authority drift, governance translation, and decision accountability |
| **Supporting review scope** | Privacy, cybersecurity, software architecture, data stewardship, vulnerable-population protection, and Catholic governance where they intersect with algorithmically assisted or AI-mediated decisions |
| **Outside individual attestation authority** | Legal compliance, penetration testing, canonical judgment, safeguarding certification, cryptographic certification, independent software validation, and final CDCF disposition |
| **Method ownership** | The evaluating member authored and applies the review method in this memo. It is proposed for this evaluation and is not represented as an already adopted CDCF-wide standard. |
| **Review status** | Preliminary professional assessment submitted for project-owner response, TAC scrutiny, independent review, and Board disposition |

### Evaluating Member’s Scope Statement

My role in this review is not to substitute for the software engineer, security reviewer, privacy counsel, safeguarding authority, canonical advisor, or Board. My role is to examine whether FamilyGraph preserves accountable human judgment and institutional responsibility where automated matching, scoring, pseudonymization, data synchronization, and external-AI workflows shape decisions about persons.

The governing question is:

> Can the institution show who saw the evidence, who interpreted the system output, who exercised independent judgment, who could reject or stop the action, who heard appeal, who repaired harm, and who changed the system after failure?

That is the point at which AI governance and AI safety become institutional governance.

### AI-Safety Research Lens

The AI-safety contribution to this review is deliberately bounded.

It is used to examine:

- objective and specification failure;
- proxy substitution and Goodhart effects;
- generalization failure across institutions and populations;
- interpretability and evaluation gaps;
- correction and corrigibility failure;
- automation bias and reviewer overreliance;
- authority drift into technical infrastructure;
- human influence erosion;
- institutional inability to reconstruct, repair, and reform after harm.

It is not used to relabel every deterministic component as “AI.” FamilyGraph is principally identity-governance infrastructure. AI-safety analysis applies where automated systems shape consequential identity, disclosure, consent, family, or institutional decisions, and where pseudonymization creates a pathway to external AI use.
...
### Evaluating Member’s Preliminary Recommendation

**Mark Julius Banasihan — TAC AI Governance and AI Safety Specialist**

> Conditional incubation may be considered after the Gate 1 response package is received and reviewed. CDCF endorsement, live-family-data deployment, diocesan or multi-institution scaling, external-AI processing of real family data, and Gate 2 graduation remain deferred.

This recommendation is based on the present evidence. It should strengthen if the project supplies independent validation, named-human accountability, vulnerable-family safeguards, field-level authority rules, correction and appeal, stopping thresholds, durable stewardship, and a completed Gate 2 assurance case. It should weaken further if high-risk identity errors, disclosure failures, untraceable decisions, sanitizer leakage, unsupported deployment expansion, or failed correction propagation appear.
...
AI tools were used to assist with repository navigation, code-location discovery, source comparison, issue identification, adversarial questioning, structural analysis, and drafting.

The tools reflected in this review process include:

- **ChatGPT by OpenAI**, used for repository assessment, governance synthesis, adversarial review, structured drafting, and revision;
- **Claude and Claude Code by Anthropic**, where their use is documented in the FamilyGraph repository development history and prior review materials.

AI-generated output was treated as a research lead rather than evidence or authority.

No AI system was authorized to:

- determine CDCF project status;
- make the Gate 1 or Gate 2 decision;
- establish legal compliance;
- conduct an independent security attestation;
- validate matching performance;
- certify pseudonymization;
- supply canonical or ecclesial judgment;
- resolve project-owner or reviewer disputes;
- vote on behalf of any TAC member or the Board.

The evaluating member remains responsible for every claim retained in this memo.

Before a code-level observation becomes a formal TAC finding, it should be reproduced by a qualified human reviewer against the identified repository version. Inferences must remain distinguishable from observations. Risks must remain distinguishable from demonstrated incidents. Independent validation cannot be satisfied by asking another AI system to review the same codebase.

AI assistance created no authorship authority, voting right, certification authority, or institutional decision authority within CDCF.

### AI-Assisted Review Record

| Field | Entry |
|---|---|
| **Primary human reviewer** | Mark Julius Banasihan |
| **AI tools used** | ChatGPT; repository-development materials reflecting Claude / Claude Code |
| **Permitted use** | Navigation, synthesis, hypothesis generation, adversarial questioning, drafting |
| **Prohibited reliance** | Independent validation, legal conclusion, security certification, canonical judgment, final disposition |
| **Human verification required** | Code-level findings, source interpretation, retained inferences, risk severity, recommendation language |
| **Independent validation status** | Not satisfied by this memo |
| **Final responsibility** | Evaluating TAC member and authorized CDCF governance bodies |
...
**AI governance and AI safety reviewer:** Mark Julius Banasihan

**Preliminary finding:** FamilyGraph contains meaningful human-intervention surfaces, but the current evidence does not yet demonstrate accountable human judgment across the full decision chain.
...
**Evaluating member:** Mark Julius Banasihan — AI Governance and AI Safety Specialist
...
## AI Governance and AI Safety Findings Owned by the Evaluating Member

The following findings fall within the evaluating member’s professional review scope. They remain subject to factual correction, TAC challenge, independent evidence, and Board authority.

| Finding domain | Preliminary position | Confidence | What would change the position |
|---|---|---:|---|
| **System classification** | FamilyGraph is high-consequence identity-governance infrastructure with automated and AI-adjacent functions; it should not be treated wholesale as a general-purpose AI system | High | Evidence that additional trained-model or autonomous behavior exists in the reviewed release |
| **Human oversight** | Current controls show human intervention, not yet full accountable human judgment | High | Named-user, evidence-view, reason, override, appeal, remediation, and reform records |
| **Automation bias** | Plausible and unmeasured | Moderate | Reliance telemetry showing healthy rejection, escalation, evidence review, and reason quality |
| **Confidence-score governance** | Scores should not be treated as calibrated probabilities absent validation | High | Independent calibration evidence |
| **Pseudonymization** | Useful risk-reduction control; not anonymity and not permission for AI export | High | Independent leakage and re-identification evidence plus approved destination governance |
| **External AI workflow** | Real family or student data should remain disabled until destination, retention, training use, approval, and leakage controls are governed | High | Approved AI-export policy and validation evidence |
| **Vulnerable populations** | Children and complex families face foreseeable higher-severity linkage risk | High plausibility; occurrence unproven | Representative validation and safeguarding evidence showing controls reduce risk below approved thresholds |
| **Human influence telemetry** | Required for any consequential live pilot | High | Equivalent evidence architecture demonstrating counsel, judgment, command, appeal, repair, and reform |
| **Stopping rules** | Must be predetermined before live-family-data deployment | High | Board- or TAC-approved alternative governance control with equivalent force |
| **Gate 1** | Conditional incubation may be considered after response package | Moderate to high | Project refusal to accept evidence-producing incubation or emergence of P0 failures |
| **Gate 2** | Not ready | High | Completed assurance case and independent operational evidence |
...
The evaluating member has completed this section as a provisional self-audit. Checked items represent the present review posture and remain open to correction if contrary evidence appears.

### Reviewer declarations — Mark Julius Banasihan

- [x] I have disclosed my role as a CDCF TAC member and AI Governance / AI Safety Specialist.
- [x] I have identified the areas within my professional review scope and the areas requiring other specialists.
- [x] I have identified which claims rely on repository observations, which are inferences, and which are forward-looking risks.
- [x] I have searched for evidence that weakens a favorable view of the project.
- [x] I have searched for evidence that weakens an unfavorable view of the project.
- [x] I have corrected or narrowed earlier claims rather than silently removing them.
- [x] I have not treated Catholic identity, open-source status, local deployment, encryption, or developer reputation as proof of safety.
- [x] I have not treated missing evidence as proof that a specific harm has already occurred.
- [x] I have stated what evidence would update the disposition toward approval.
- [x] I have stated what evidence would require restriction, suspension, or no-go.
- [x] I have preserved a route for Chris Treadaway to correct factual errors, dispute inferences, and supply evidence.
- [x] I have distinguished incubation from endorsement, live deployment, Gate 2 graduation, and Board approval.
- [x] I have not represented this memo as legal advice, canonical judgment, safeguarding certification, penetration testing, or independent validation.
- [x] I have considered the family least able to detect, explain, or contest an error.
- [x] I have disclosed AI assistance and denied AI systems any authority to validate, certify, vote, or decide.
- [ ] I have personally reproduced every code-level claim in the memo.
- [ ] Independent software, security, privacy, safeguarding, and legal reviewers have completed their assigned review lanes.
- [ ] The project owner has responded to all P0 and P1 findings.
- [ ] The TAC has deliberated and recorded agreement, dissent, recusals, and conditions.
- [ ] The Board has issued a final disposition.

### Interpretation of unchecked items

Unchecked items are not defects in candor. They identify work that remains before this memo can become a formal CDCF finding or Board-ready record.
...
| Pseudonymization is sufficient for external AI use | Low / unknown | No independent leakage or re-identification results | Validated sanitizer plus approved AI destination and data-use controls |
| Human review currently proves accountable judgment | Low / partial | Conflict review exists, but identity, reason, authority, appeal, and repair evidence is incomplete | Human influence telemetry demonstrating the complete decision chain |

### Evaluating Member Attestation

I attest that this memo represents my present professional judgment within the scope stated above. I have used rationality as a method of error correction rather than as a stylistic posture: claims are intended to be inspectable, sources functional, concepts operational, uncertainty visible, responsibility traceable, and repair possible.

This attestation does not convert the memo into a CDCF decision.

| Field | Entry |
|---|---|
| **Name** | Mark Julius Banasihan |
| **Role** | TAC — AI Governance and AI Safety Specialist |
| **Status** | Preliminary professional assessment |
| **Date** | June 2026 |
| **Signature / approval** | To be completed by evaluating member before formal submission |
...
| 1.2 → 1.3 | Methodology, human control, and Gate analysis still blurred philosophical method, incubation readiness, and graduation readiness | Converted to method cards, human-control cards, Gate 1 incubation cards, Gate 2 graduation cards, and pressure-test modules | The memo must show what is needed now, before live use, and before CDCF endorsement |
| 1.3 → 1.4 | Evaluating-member role, AI-safety research posture, AI-assistance disclosure, and reviewer self-governance were present but insufficiently explicit | Added signed scope, AI-safety lens, AI-governance finding ownership, full AI-assistance disclosure, completed self-governance record, and attestation | The review must show who owns which judgment and how the reviewer governs the review |
...
*Prepared by Mark Julius Banasihan, TAC AI Governance and AI Safety Specialist. June 2026.*
